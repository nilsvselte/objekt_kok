...
public class Ordbok extends Bok {
	...
	public static void main(String[] args) {
		...
		System.out.println(ordbok); // Hvordan finner den ut hva den skal skrive her?
		// Ordbok ordbok2 = new Ordbok("Nynorsk ordbøk", 98543);
		// System.out.println(ordbok2);

		System.out.println(ordbok instanceof Bok);
		System.out.println(ordbok.getClass().equals(uke11.arv.bok_avansert.Bok.class));
		System.out.println(ordbok.getClass().equals(uke11.arv.bok_avansert.Ordbok.class));
